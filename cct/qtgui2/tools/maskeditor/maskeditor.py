...
class MaskEditor(QtWidgets.QWidget, WindowRequiresDevices, Ui_Form):
    ...
    def setupUi(self, Form):
        ...
        frame1.setSizePolicy(QtWidgets.QSizePolicy.Preferred, QtWidgets.QSizePolicy.Minimum)
        ...
        frame2.setSizePolicy(QtWidgets.QSizePolicy.Preferred, QtWidgets.QSizePolicy.Minimum)
