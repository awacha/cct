...
class ExposureTask(QtCore.QObject):
    ...
    def writeNeXus(self, img: np.ndarray, unc: np.ndarray):
        ...
        instgroup = [g for g in grp if grp[g].attrs['NX_class'] == 'NXinstrument'][0]
        detectorgroup: h5py.Group = [g for g in instgroup if instgroup[g].attrs['NX_class'] == 'NXdetector'][0]
