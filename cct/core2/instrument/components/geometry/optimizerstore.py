...
class OptimizerStore(QtCore.QAbstractItemModel):
    ...
    def data(self, index: QtCore.QModelIndex, role: int = ...) -> Any:
        columnlabel = self.headerData(index.column(), QtCore.Qt.Orientation.Horizontal, QtCore.Qt.ItemDataRole.DisplayRole)
    ...
    def sort(self, column: int, order: QtCore.Qt.SortOrder = ...) -> None:
        columnlabel = self.headerData(column, QtCore.Qt.Orientation.Horizontal, QtCore.Qt.ItemDataRole.DisplayRole)
