...
def autoabscissa(double wavelength, double
...
double
bcx, double
bcy, np.ndarray[np.uint8_t, ndim = 2] mask
not None,
bint
linspacing = True, int
abscissa_kind = 0):
...
def radint_fullq(np.
    ...
    ndarray[np.double_t, ndim = 2] data
not None,
...
np.ndarray[np.uint8_t, ndim = 2] mask,
                                 np.ndarray[np.double_t, ndim = 1] q = None,
                                                                       int
errorpropagation = 2, int
abscissa_errorpropagation = 2,
                            bint
...
"""
cdef
np.ndarray[np.double_t, ndim = 1] qout, dqout, Intensity, Error, Area, pixelout
cdef
np.ndarray[np.double_t, ndim = 2] x, y
cdef
Py_ssize_t
ix, iy, l, maxlog, M, N, Numq
cdef
double
q1, dq1, rho
cdef
